  ...
  if (framed) {
    return (
      ...
      >
        ...
        <g fill="#f8fafc" transform="translate(10 14) scale(0.0978)">
          {MARK}
        </g>
      </svg>
    );
